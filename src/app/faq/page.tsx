...
const faqData: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      'Бот зарабатывает 30-72% В ДЕНЬ от вашего депозита (для расчетов используем верхнюю планку 72%). Это реальный заработок от арбитража между DEX. Ваша доля растёт постепенно: первая неделя — 0.5% в день, через 26 недель — 100% доступ ко всему дневному профиту.',
  },
