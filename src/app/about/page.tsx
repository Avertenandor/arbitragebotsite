    ...
    <div className="container mx-auto px-4 py-12 max-w-6xl">
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-[var(--text-secondary)]">
              Безопасный вход через MetaMask или Trust Wallet. Авторизация
              происходит через отправку 1 PLEX токена с on-chain верификацией.
            </p>
          </motion.div>
      ...
      >
        ...
        <p className="text-[var(--text-secondary)] text-lg mb-6 max-w-2xl mx-auto">
          Подключите кошелек, авторизуйтесь через 1 PLEX и получите доступ к
          личному кабинету с детальной статистикой вашей активности.
        </p>
        <div className="flex flex-wrap gap-4 justify-center">
          <Link
            href="/"
